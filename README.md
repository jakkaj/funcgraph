...
Installation is easy - head to the Kudu SCM for your Function site, click on Site Extensions and search for "Function". Once it's installed you will need to hit ```Restart Site```.
